...
score of that final molecule (activity, QED, SA, similarity, \dots). Autoregressive
...
a VAE) and then generate by sampling a latent vector $\zvec$ and \emph{decoding} it.
...
\begin{description}
  \item[One-shot] --- predict all atom types and the bond-adjacency tensor at once.
        Conceptually simple, but hard to enforce valence and connectivity.
