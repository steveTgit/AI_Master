...
% Exam figure helper. Usage:
%   \examfigure[width=0.75\linewidth]{figures/my-question-figure.png}
...
and answer choices were kept intact. If a question depends on a source figure or screenshot,
include the image from \texttt{figures/} instead of replacing it with a long prose description.
\end{notebox}
